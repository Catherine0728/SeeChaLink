...
public class AlarmAlertFullScreen extends Activity {
	public static String TAG = "AlarmAlertFullScreen";
	...
	private void updateLayout() {
		...
		findViewById(R.id.dismiss).setOnClickListener(
				new Button.OnClickListener() {
					public void onClick(View v) {
						dismiss(false);
						myHander.sendEmptyMessage(STOP);
					}
				});

		/* Set the title from the passed in alarm */
		setTitle();
		myHander.sendEmptyMessage(PUB);
	}
	 ...
	 * 
	 * */
	public static final int PUB = 0x999999;
	public static final int STOP = 0x888888;
	Handler myHander = new Handler() {

		public void handleMessage(android.os.Message msg) {
			if (null == mcu) {
				mcu = MQTTClientUtil.getInstance(AlarmAlertFullScreen.this);

			}

			switch (msg.what) {
			case PUB:
				TopicMess = Configer.GetRf3o4MWirelessCtrlClickJson(9);
				mcu.publish(Configer.topicName, TopicMess, 2);
				break;
			case STOP:
				TopicMess = Configer.GetRf3o4MWirelessCtrlClickJson(1);
				mcu.publish(Configer.topicName, TopicMess, 2);
				break;
