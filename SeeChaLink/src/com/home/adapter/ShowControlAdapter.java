...
/**
 * 
 * 建立一个适配器来显示已经存在的遥控，然后尽进行显示选择
 * 
 * @author Catherine
 */
public class ShowControlAdapter extends BaseAdapter {
	public static String TAG = "ShowControlAdapter";
	...
	public ShowControlAdapter(Context mContext, ArrayList<String> mLsit,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (null == convertView) {
			convertView = LayoutInflater.from(mContext).inflate(
					R.layout.control_dis_item, null);
